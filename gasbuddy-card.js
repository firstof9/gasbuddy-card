        ...
        <div class="footer">
          ...
          ${s.last_updated?B`
                <div class="last-updated">
                  ...
                  <span>Updated: ${we(this.hass.states[s.last_updated]?.state)}</span>
                </div>
              `:""}
        </div>
      </ha-card>
