      ...
      `),i.add("visa"));return s}(String(_));return e.length>0?z`<div class="payment-icons-container">${e}</div>`:_})()}
          ...
          ${g&&"unknown"!==g&&"unavailable"!==g?z`
                <div class="metadata-item">
                  ...
                  <span class="metadata-val">${ve(g)}</span>
                </div>
              `:""}
        </div>
      </div>
    `}};e([he({attribute:!1})],ye.prototype,"hass",void 0),e([pe()],ye.prototype,"_config",void 0),e([pe()],ye.prototype,"_activeTab",void 0),ye=e([ce("gasbuddy-card")],ye),window.customCards=window.customCards||[],window.customCards.push({type:"gasbuddy-card",name:"GasBuddy Card",preview:!0,description:"A premium Home Assistant custom card for GasBuddy integration gas prices and EV stations."});export{ye as GasBuddyCard};
