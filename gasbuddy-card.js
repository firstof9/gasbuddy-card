      ...
      <ha-card>
        ...
        <div class="header">
          ...
          <div
            ...
            aria-hidden="true"
          >
            ${"ev"===n&&s.ev_network?function(e){const t=me(e);return t?t.svgPath?B`
      <svg
        class="network-svg"
        viewBox="0 0 24 24"
        role="img"
              ...
              <div>
                ...
                <div class="connectors-grid">
                  ${o.map(e=>{const t=this.hass.states[e.countId]?.state||"0",s=e.powerId?this.hass.states[e.powerId]?.state:void 0,i=s&&"unknown"!==s&&"unavailable"!==s;return B`
                      <div class="connector-card" role="group" aria-label="${t} ${e.name} connectors${i?`, power capacity ${s} kilowatts`:""}">
